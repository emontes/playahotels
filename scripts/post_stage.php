...
mkdir($directorio . "/data",0777);
chmod($directorio . "/data", 0777);
mkdir($directorio . "/data/cache",0777);
chmod($directorio . "/data/cache", 0777);
mkdir($directorio . "/data/logs",0777);
chmod($directorio . "/data/logs", 0777);